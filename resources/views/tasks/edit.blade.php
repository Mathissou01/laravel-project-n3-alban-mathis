                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control form-control-solid @error('name') is-invalid @enderror" id="name" name="name" type="text" placeholder="" value="{{ old('name', $task->name) }}" autocomplete="off"/>
                            @error('name')
                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select form-control-solid @error('category_id') is-invalid @enderror" id="category_id" name="category_id">
                                    ...
                                    <option value="{{ $category->id }}" @if(old('category_id', $task->category_id) == $category->id) selected="selected" @endif>{{ $category->name }}</option>
                                    @endforeach
                                </select>
                                @error('category_id')
                                <div class="invalid-feedback">
                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('date') is-invalid @enderror" id="date" name="date" type="text" placeholder="" value="{{ old('date', $task->date) }}" autocomplete="off" />
                                @error('date')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
